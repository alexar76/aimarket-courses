...
from courselib.certificate import certificate_id, render_html
...
def test_certificate_fr_zh_labels():
    fr = render_html("Ada", lang="fr")
    zh = render_html("Ada", lang="zh")
    assert "Certificat" in fr
    assert "结业证书" in zh
