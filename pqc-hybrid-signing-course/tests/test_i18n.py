"""Tests for the course localization system (en/ru/es/fr/zh)."""
...
def test_supported_five_languages():
    assert SUPPORTED == ("en", "ru", "es", "fr", "zh")
...
def test_non_english_catalogs_differ_from_en():
    en = get_translator("en")("modules.m1.title")
    for lang in ("ru", "es", "fr", "zh"):
        other = get_translator(lang)("modules.m1.title")
        assert other != en, f"{lang} title unexpectedly equals EN"
