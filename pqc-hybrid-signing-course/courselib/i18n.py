...
mental model:
  - supported languages: en / ru / es / fr / zh (extend by dropping a new JSON catalog)
  - dot-path keys ("modules.m1.title"), JSON catalogs in i18n/<lang>.json
