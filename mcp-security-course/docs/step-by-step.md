...
4. Open `warden/src/static-scan.ts` in the monorepo — compare regex parity with `courselib/warden.py`.
...
5. Cross-read: [argus/docs/channels.md](https://github.com/alexar76/argus/blob/main/docs/channels.md) § Telegram owner-lock.
...
1. **Read WARDEN docs** — [argus/docs/security-warden.md](https://github.com/alexar76/argus/blob/main/docs/security-warden.md)
...
4. **Hub supply security** — [aimarket-hub/docs/supply-security.md](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md)
...
- [ ] Open `warden/src/index.ts` and find the production gate order
...
**ARGUS issues:** [argus/README.md](https://github.com/alexar76/argus/blob/main/README.md)
