...
4. Abre `warden/src/static-scan.ts` en el monorepo — compara la paridad de regex con `courselib/warden.py`.
...
5. Lectura cruzada: [argus/docs/channels.md](https://github.com/alexar76/argus/blob/main/docs/channels.md) § owner-lock de Telegram.
...
1. **Lee la documentación de WARDEN** — [argus/docs/security-warden.md](https://github.com/alexar76/argus/blob/main/docs/security-warden.md)

2. **Mapeo curso → ARGUS**

   | Curso | ARGUS |
   |-------|-------|
   | M2 static-scan | `warden/src/static-scan.ts` |
...
4. **Seguridad de supply en Hub** — [aimarket-hub/docs/supply-security.md](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md)
...
- [ ] Abrir `warden/src/index.ts` y encontrar el orden de gates de producción
...
**Problemas con ARGUS:** [argus/README.md](https://github.com/alexar76/argus/blob/main/README.md)
