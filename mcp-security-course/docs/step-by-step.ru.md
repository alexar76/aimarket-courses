...
4. Откройте `warden/src/static-scan.ts` в монорепозитории — сравните паритет регулярок с `courselib/warden.py`.
...
5. Доп. чтение: [argus/docs/channels.md](https://github.com/alexar76/argus/blob/main/docs/channels.md) § Telegram owner-lock.
...
1. **Прочитайте документацию WARDEN** — [argus/docs/security-warden.md](https://github.com/alexar76/argus/blob/main/docs/security-warden.md)
...
4. **Безопасность supply в Hub** — [aimarket-hub/docs/supply-security.md](https://github.com/alexar76/aimarket-hub/blob/main/docs/supply-security.md)
...
- [ ] Открыть `warden/src/index.ts` и найти боевой порядок gate
...
**Проблемы с ARGUS:** [argus/README.md](https://github.com/alexar76/argus/blob/main/README.md)
