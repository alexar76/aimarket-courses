...
<p align="center">
  <a href="https://github.com/{GITHUB_REPO}/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/{GITHUB_REPO}/ci.yml?branch=main&label=CI" alt="CI" /></a>
