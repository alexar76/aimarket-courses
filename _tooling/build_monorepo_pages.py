...
def _course_card(folder: str, cfg: dict, taglines: dict[str, str]) -> str:
  ...
  <div class="meta">
    ...
    <span class="chip">EN / RU / ES / FR / ZH</span>
...
<head>
  ...
  <meta name="description" content="Thirteen hands-on Python academies on agent orchestration, physical-world sensors, federation, hybrid PQC signing, verifiable oracles, MCP security, and more — EN/RU/ES/FR/ZH labs with Colab notebooks wired to the live AIMarket ecosystem." />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="AIMarket Courses" />
  <meta property="og:description" content="Learn agent orchestration against a real economy — not toy examples. Thirteen courses, five languages, live sandboxes." />
...
<body>
  ...
  <header class="hero wrap" id="top">
    ...
    <p class="lede">Not slides about LangChain — runnable labs that call real oracles, open payment channels, scan MCP servers with WARDEN, read GAIA/ATLAS pins, federate hubs, and verify hybrid receipts.</p>
    <p class="sub">Each academy is a self-contained folder: pytest CI, graded exercises, HTML certificates, step-by-step docs, and Colab notebooks in <strong>English, Russian, Spanish, French, and Chinese</strong>.</p>
    <div class="cta-row">
      ...
      <a class="btn btn-ghost" href="https://edu.modelmarket.dev/" target="_blank" rel="noopener">School clips ↗</a>
    </div>
    <div class="hero-meta">
      <span><b>{course_count}</b> courses</span>
      <span><b>5</b> languages</span>
      <span><b>70+</b> Colab notebooks</span>
    ...
    <div class="wrap">
      ...
      <div class="pillars">
        ...
        <article class="pillar">
          ...
          <p>Full EN / RU / ES / FR / ZH localization — lab docstrings, step-by-step guides, notebooks, and certificates. Run locally or one-click in Colab.</p>
        </article>
      </div>
    </div>
  </section>
  ...
  <section id="method">
    <div class="wrap">
      <div class="sec-head">
        ...
        <p>Same spine across all academies — pick a track, run labs in order, graduate with a certificate.</p>
      </div>
      <div class="flow">
        <div class="flow-node">
          <div class="ic">📖</div>
  ...
  <section id="catalog">
    <div class="wrap">
      <div class="sec-head">
        ...
        <h2>{course_count} academies · four tracks</h2>
        <p>Agent builder · security &amp; crypto · physical world · trust &amp; proofs. Deepen the same spine — don't invent ten more random courses.</p>
      </div>
      <div class="filters" role="group" aria-label="Filter by track">
        ...
        <button type="button" class="filter-btn" data-filter="builder">Agent builder</button>
        <button type="button" class="filter-btn" data-filter="security">Security &amp; crypto</button>
        <button type="button" class="filter-btn" data-filter="physical">Physical world</button>
        <button type="button" class="filter-btn" data-filter="proofs">Trust &amp; proofs</button>
      </div>
      {tracks_html}
    </div>
  </section>
  ...
  <footer>
    <div class="wrap">
      <div class="foot-links">
        ...
        <a href="https://edu.modelmarket.dev/" target="_blank" rel="noopener">School</a>
        <a href="https://iot.modelmarket.dev/" target="_blank" rel="noopener">GAIA</a>
        <a href="https://atlas.modelmarket.dev/" target="_blank" rel="noopener">ATLAS</a>
      </div>
...
def main() -> int:
    ...
    # Orbitron and Rajdhani, served by the published site instead of by Google. The portal
    # head used to <link> them from fonts.googleapis.com, which disclosed every visitor's
    # address to a third party. Populate with scripts/selfhost_google_fonts.py.
    if (PORTAL / "fonts").is_dir():
        shutil.copytree(PORTAL / "fonts", assets / "fonts")
