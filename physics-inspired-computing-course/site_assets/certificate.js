...
<head>
  ...
  <!-- Absolute, resolved against the page that issued the certificate: this markup is handed
       to window.open("") + document.write, where a bare relative href resolves against
       about:blank rather than the site. Inter and Playfair are in the site's own font bundle;
       the font-family chains below still end in system-ui if it cannot be reached. -->
...
<body>
  ...
  <article class="cert">
    ...
    <div class="footer">
      <div>AIMarket · ${esc(courseTitle)} · open course</div>
