# Guide pas à pas — Verifiable Randomness & Cryptographic Time
...
Colab : ouvrez le [site du cours](https://alexar76.github.io/aimarket-courses/verifiable-randomness-course/) → **Open in Colab**.
