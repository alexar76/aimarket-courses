...
def test_ru_and_es_actually_differ_from_en():
    ...
    ru = get_translator("ru")("modules.m1.title")
    es = get_translator("es")("modules.m1.title")
    assert en != ru or en != es  # ru/es may partially match EN titles; at least one differs or localized site strings differ
