...
7. [M5 — State и context](#m5--state-и-context)
8. [M6 — Guardrails](#m6--guardrails)
9. [M7 — Trust и receipts](#m7--trust-и-receipts)
10. [M8 — Экономика оркестрации (продвинутый)](#m8--экономика-оркестрации-продвинутый)
11. [LLM (опционально)](#llm-опционально)
12. [Упражнения и сертификат](#упражнения-и-сертификат)
13. [M9 — Наблюдаемость](#m9--наблюдаемость-в-каждой-лабе)
14. [Мост: от курса к AI-Factory](#мост-от-курса-к-ai-factory)
15. [Чеклист самопроверки](#чеклист-самопроверки)
...
1. Откройте [сайт курса](https://alexar76.github.io/aimarket-courses/orchestration-course/) → **Open in Colab**.
...
3. Production: [observability-langsmith.md](https://github.com/alexar76/aicom/blob/main/docs/observability-langsmith.md)
...
3. [USER_GUIDE.ru.md](https://github.com/alexar76/aicom/blob/main/docs/USER_GUIDE.ru.md) — «Первые 15 минут»: Admin → New product → Pipeline
4. Сопоставление:
...
Factory: [FAQ.ru.md](https://github.com/alexar76/aicom/blob/main/docs/FAQ.ru.md)
